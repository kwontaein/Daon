...
import {getProcurementApi} from "@/features/accounting/api/search-server-api";
...
export default async function PsetPage({searchParams}: PageByProps) {
    ...
    return (
        <AccountingSearch companyList={companyList} division='pset' initialListState={procurementList} page={page}/>
    )
}