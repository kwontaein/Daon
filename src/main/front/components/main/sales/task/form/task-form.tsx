            ...
            <table className='register-form-table'>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input name='requesterName' defaultValue={state.requesterName} readOnly={mode==='detail'}/></td>
                    </tr>
                    <tr>
                        <td className='table-label'>의뢰자 연락처</td>
                        <td><input name='requesterContact' defaultValue={state.requesterContact} readOnly={mode==='detail'}/></td>
                        <td className='table-label'>의뢰자 휴대폰</td>
                        <td><input name='requesterContact2' defaultValue={state.requesterContact2} readOnly={mode==='detail'}/></td>
                    </tr>
                    <tr>
