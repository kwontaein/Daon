...
import {exportLedgerCustomersToExcel} from "@/components/main/ledger/ledger-customers/exportLedgerCustomersToExcel";
                    ...
                    <table className='search-table'>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type='hidden' name='customerIds' value={JSON.stringify(state.customerIds) + ''}
                                       readOnly/>
                            </td>
                        </tr>
                        <tr>
