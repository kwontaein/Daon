...
import LedgerPurchaseSearchResult from './saerch-result';
                ...
                <thead>
                    <tr>
                        <td colSpan={4} className="table-title">
                            품목 분류 &nbsp;: &nbsp;
                            <label>
                                <select className="title-selector" size={1} name='stockCate' defaultValue={state.stockCate} key={state.stockCate}>
