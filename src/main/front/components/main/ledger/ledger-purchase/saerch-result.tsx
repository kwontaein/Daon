...
export default function LedgerPurchaseSearchResult({searchInfo}:{searchInfo:{searchResult:ResponseLedger[], searchTitle:string}}){
        ...
        <table className='search-result-table'>
            ...
            <tbody>
                ...
                <tr className='none-hover' style={{borderBottom:'none'}}>
                    ...
                    <td className='right-align'><b>{totalResult.outPrice.toLocaleString('ko-KR')}</b></td>
