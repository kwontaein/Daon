                ...
                <table className={`search-result-table  ${mode !== 'pc' ? 'mobile' : ''}`}>
                    ...
                    {mode === 'pc' ?
                        ...
                        {expenseProofs.map((expenseProof) => (
                            <tr key={expenseProof.expenseProofId} ref={(el) => {
                                itemsRef.current[expenseProof.expenseProofId] = el
                            }} className={target === expenseProof.expenseProofId ? 'is-click' : ''}>
                                ...
                                <td className='icon'
                                    onClick={() => target === expenseProof.expenseProofId ? setTarget(null) : setTarget(expenseProof.expenseProofId)}>
                        ...
                        :
                        expenseProofs.map((expenseProof) => (
                            <tbody key={expenseProof.expenseProofId} ref={(el) => {
                                itemsRef.current[expenseProof.expenseProofId] = el
                            }} className={target === expenseProof.expenseProofId ? 'is-click' : ''}>
                            <tr>
